...
class QueueProgressDialog(QProgressDialog):
    ...
    def do_queue(self):
        ...
        self.queue(self.tdir, self.books_to_scan, self.statistics_cols_map, self.pages_algorithm,
                   self.custom_chars_per_page, self.icu_wordcount, self.page_count_mode,
