...
class CountPagesAction(InterfaceAction):
    ...
    def _do_count_pages(self, book_ids, statistics_cols_map, page_count_mode='Estimate', download_source=None):
        ...
        QueueProgressDialog(self.gui, book_ids, tdir, statistics_cols_map,
                            ...
                            icu_wordcount, self._queue_job, db, page_count_mode=page_count_mode,
                            download_source=download_source)

    def _queue_job(self, tdir, books_to_scan, statistics_cols_map, pages_algorithm, custom_chars_per_page,
                   icu_wordcount, page_count_mode='Estimate', download_source=None):
